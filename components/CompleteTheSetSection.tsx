...
import {SetCarousel} from './completesetCarousal'
...
export function CompleteTheSetSection() {
  return (
    <section className="border-t border-border/80 bg-background py-10 md:py-10" aria-labelledby="complete-set-heading">
