                    ...
                    <div className='hidden lg:flex flex-col justify-between w-[45%] text-foreground p-12 relative'>
                        ...
                        <div className='relative z-10 space-y-6'>
                            <div className='flex items-start gap-4'>
                                ...
                                <div>
                                    <h4 className='font-semibold text-sm text-foreground'>Welcome Email & Offers</h4>
                                    <p className='text-muted-foreground text-xs mt-1 leading-relaxed'>Get a personalized welcome and exclusive member deals right in your inbox.</p>
                                </div>
                            </div>
                            <div className='flex items-start gap-4'>
                                <div className='p-2.5 bg-card/60 border border-rose-200/50 rounded-xl shrink-0 mt-0.5 shadow-sm'>
                                ...
                                <div>
                                    <h4 className='font-semibold text-sm text-foreground'>Early Access & Rewards</h4>
                                    <p className='text-muted-foreground text-xs mt-1 leading-relaxed'>Be the first to know about limited drops, new collections, and seasonal sales.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='flex-1 p-8 sm:p-12 lg:p-16 flex flex-col justify-center relative'>
                        <div className='max-w-sm mx-auto w-full'>
                            <div className='mb-8'>
                                ...
                                <p className='text-muted-foreground text-sm mt-2'>Join us and explore the world of artisan luxury</p>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className='space-y-5'>
                                ...
                                <div className='space-y-2'>
                                    ...
                                    <p className='text-[11px] text-muted-foreground ml-1'>Must be at least 6 characters</p>
                                </div>
                            ...
                            <div className='mt-8 text-center'>
                                <div className='relative flex items-center gap-4 mb-6'>
                                    ...
                                    <span className='text-xs text-muted-foreground font-medium uppercase tracking-widest'>Already a member?</span>
                                    <div className='flex-1 h-px bg-neutral-200' />
                                </div>
                                <Link
                                    href='/login'
