...
export default function EditProductPage() {
    ...
    if (isLoading) return <div className='min-h-screen bg-background flex items-center justify-center font-bold text-2xl'>Loading Magic...</div>
    if (!product) return <div className='min-h-screen bg-background flex items-center justify-center font-bold text-2xl'>Product Not Found</div>
                ...
                <div className='flex flex-col lg:flex-row gap-8'>
                    ...
                    <div className='lg:w-2/3 space-y-6'>
                        <Card className='border-none shadow-xl bg-card/80 backdrop-blur-md rounded-3xl overflow-hidden'>
                                    ...
                                    <div className='space-y-2'>
                                        ...
                                        <div className='h-12 flex items-center gap-4 px-1'>
                                            <button
                                                ...
                                                className={`px-6 py-2 rounded-full font-bold transition-all ${product.inStock ? 'bg-emerald-500 text-white shadow-lg shadow-emerald-200' : 'bg-neutral-200 text-muted-foreground'}`}
                                            >
                            ...
                            <CardFooter className='bg-neutral-50  flex-col md:flex-row gap-6 md:gap-0 p-8 flex justify-between items-center border-t border-border'>
                                <Button 
                                    variant='ghost' 
                                ...
                                <div className='flex gap-4 md:flex-row flex-col md:w-auto w-full'>
                                    <Button variant='outline' className='rounded-xl h-12 px-8 font-bold border-border' onClick={() => router.push('/allproduct')}>
                                        Cancel
                                    </Button>
                                    <Button
