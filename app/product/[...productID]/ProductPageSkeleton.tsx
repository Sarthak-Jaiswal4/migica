  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none relative z-[1] m-auto flex flex-col items-center justify-center gap-1.5 px-6 text-center">
        <span className="text-[10px] font-bold uppercase tracking-[0.22em] text-muted-foreground">Photo</span>
...
export function ProductPageSkeleton() {
  return (
    <div className="min-h-screen bg-background" aria-busy="true" aria-label="Loading product">
      <Headers />
      <div className="mx-auto mt-20 max-w-7xl overflow-x-clip px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 flex flex-col gap-12 lg:flex-row lg:items-start">
          ...
          <div className="w-full space-y-7 lg:w-[45%] lg:flex-shrink-0">
            ...
            <div className="space-y-3">
              <p className="text-[10px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">Features incoming</p>
            ...
            <div className="grid grid-cols-3 gap-3">
              {Array.from({ length: 3 }).map((_, i) => (
                <div
                  key={i}
                  className="flex h-28 flex-col items-center justify-center gap-2 rounded-2xl border border-border bg-card/80 p-3 shadow-sm"
                >
        ...
        <div className="mb-16">
          <div className="flex h-14 w-full gap-1 rounded-xl border border-border bg-neutral-100/90 p-0.5 sm:h-16 sm:gap-2 sm:rounded-2xl">
            {Array.from({ length: 3 }).map((_, i) => (
              <div
                key={i}
          ...
          <div className="mt-6 rounded-xl border border-border bg-card p-6 shadow-sm sm:rounded-2xl sm:p-8">
            <TextIncomingLines label="Tab content incoming" widths={[100, 100, 92, 48, 100, 100, 78]} />
          </div>
        </div>

        <p className="mb-4 text-[10px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">Related items</p>
