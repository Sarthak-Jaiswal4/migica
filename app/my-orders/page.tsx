        ...
        <div className="min-h-screen bg-background flex flex-col">
            ...
            <main className="flex-grow pt-28 pb-16 px-4 sm:px-8">
                <div className="max-w-4xl mx-auto">
                    <h1 className="text-3xl font-semibold tracking-tight text-foreground mb-2">My Orders</h1>
                    <p className="text-muted-foreground text-sm font-medium tracking-wide mb-8">View and track your previous purchases</p>
                    ...
                    {loading ? (
                        ...
                        <div className="bg-card rounded-3xl p-12 text-center border border-border shadow-sm">
                            <div className="w-16 h-16 bg-neutral-50 rounded-full flex items-center justify-center mx-auto mb-4 text-muted-foreground">
                                <Package size={32} />
                            </div>
                            <h3 className="text-3xl font-bold text-foreground mb-2 font-[style]">No orders yet</h3>
                            <p className="text-muted-foreground text-sm tracking-wide font-medium">When you purchase something, it will appear here.</p>
                        </div>
                    ) : (
                        <div className="flex flex-col gap-6">
                            {orders.map((order) => (
                                <div key={order._id} className="bg-card rounded-3xl p-6 md:p-8 border border-border shadow-sm transition-all hover:shadow-md">
                                    ...
                                    <div className="flex flex-col gap-4">
                                        {order.items.map((item: any, idx: number) => (
                                            <div key={idx} className="flex items-center justify-between">
                                                <div className="flex items-center gap-4">
                                                    <div className="w-12 h-12 bg-neutral-100 rounded-lg flex-shrink-0 border border-border overflow-hidden">
                                                        {item.image ? (
